...
public class NotificationChangeIntentionEspresso {
    ...
    public void notifyChangedIntentionEspresso() {
        FitnessServiceFactory.put(TEST_SERVICE, new FitnessServiceFactory.BluePrint() {
            ...
            public FitnessService create(HomeScreenActivity homeScreenActivity) {
                return new NotificationChangeIntentionEspresso.TestFitnessService(homeScreenActivity);
            }
        });
        ...
        UpdateFirebase.acceptProposedWalk("testRoute", "testFriend-test.com");
        UpdateFirebase.rejectProposedWalk("testRoute", "testFriend-test.com", "\n(bad time)");

        FirebaseFirestore.getInstance().collection("users/testFriend-test.com/proposedRoutes").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
